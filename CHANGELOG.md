...
- Added a "Generate from video" action to the Thumbnail section of the short-video and video composer that extracts four evenly spaced frames from the post's own video and uploads the selected frame as the publication thumbnail.
