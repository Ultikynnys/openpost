...
<div class="activity-frame" {@attach activate}>
  ...
  <div class="activity-scroll">
    <div
      class="activity-rows"
      role="img"
      aria-label="Illustrative year of publishing activity across six social platforms"
    >
      {#each platforms as platform, row (platform)}
        <div class="activity-row">
          <span class="activity-label"
            ><PlatformIcon {platform} class="size-3.5" />{platform}</span
          >
...
<style>
  ...
  .activity-key i:nth-child(1) {
    background: var(--cell-1);
  }
  .activity-key i:nth-child(2) {
    background: var(--cell-2);
  }
  .activity-key i:nth-child(3) {
    background: var(--cell-3);
  }
  .activity-key i:nth-child(4) {
  ...
  :global([data-active="true"]) .activity-cells i {
    opacity: 1;
    transform: scale(1);
    transition:
  ...
  .activity-cells i.level-1 {
    background: var(--cell-1);
  }
  .activity-cells i.level-2 {
    background: var(--cell-2);
  }
  .activity-cells i.level-3 {
    background: var(--cell-3);
  }
  .activity-cells i.level-4 {
    background: var(--cell-4);
  }
