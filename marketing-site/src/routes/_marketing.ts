...
export const plans = [
  {
    ...
    price: "€6",
    description:
      "Small projects that need managed posting without extra workspace overhead.",
    limits: [
      "1 workspace",
      "3 social accounts",
  ...
  },
  {
    ...
    price: "€12",
    description:
      "For active creators and operator-led brands publishing every week.",
    limits: [
      "3 workspaces",
      "6 social accounts",
  ...
  },
  {
    ...
    price: "€24",
    description:
      "Higher limits for teams, heavier media use, and larger publishing operations.",
    limits: [
      "10 workspaces",
      "15 social accounts",
...
export const productFeatures = [
  ...
  },
  {
    eyebrow: "Media",
    title:
      "A reusable media library for scheduled work, not just an upload field.",
    description:
...
export const securityItems = [
  {
    ...
    description:
      "Social access and refresh tokens are encrypted at rest with AES-256-GCM.",
    icon: LockKeyhole,
  },
  {
    title: "Account hardening",
    description:
      "Users can enable TOTP, passkeys, and manage active browser sessions.",
    icon: ShieldCheck,
  },
  {
...
export const comparisons = [
  ...
  },
  {
    ...
    name: "Hootsuite",
    bestFor:
      "Larger teams that need a broad enterprise social management suite.",
    openPostAngle:
  ...
  },
  {
    ...
    name: "Post Bridge",
    bestFor:
      "Users who want an all-in-one hosted scheduler with many growth tools.",
    openPostAngle:
  ...
  },
  {
    ...
    name: "Mixpost",
    bestFor:
      "Self-hosted operators who want a larger PHP-based social publishing app.",
    openPostAngle:
